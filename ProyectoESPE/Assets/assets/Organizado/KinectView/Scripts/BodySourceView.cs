...
public class BodySourceView : MonoBehaviour 
{
    ...
    void Start()
    {
        fpstransform = fps.GetComponent<Transform>();
    }
    ...
    private GameObject CreateBodyObject(ulong id)
    {
        ...
        //body.transform.position = fpstransform.position;
        body.transform.parent = fpstransform;
        body.transform.position = fpstransform.position;
        Debug.Log("posicion inicial: " + body.transform.position);
    ...
    private void RefreshBodyObject(Kinect.Body body, GameObject bodyObject)
    {
        foreach (Kinect.JointType _joint in _joints){
            ...
            targetPosition.z = fpstransform.transform.position.z;
            targetPosition.x = fpstransform.transform.position.x+ targetPosition.x;
            targetPosition.y = fpstransform.transform.position.y+ targetPosition.y;
